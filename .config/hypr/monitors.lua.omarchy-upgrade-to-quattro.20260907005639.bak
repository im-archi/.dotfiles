...
hl.monitor({ output = "DP-3", mode = "3840x2160@60.0", position = "3185x1080", scale = 1.2 })
hl.monitor({ output = "HDMI-A-1", mode = "1920x1080@60.0", position = "6385x1355", scale = 1.0 })
hl.monitor({ output = "DP-1", mode = "2560x1440@144.0", position = "1745x939", scale = 1.0, transform = 1 })
